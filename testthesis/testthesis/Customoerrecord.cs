...
{
    public partial class Customoerrecord : Form
    {
        string imder = null;
        ...
        public void show()
        {
            ...
            dataGridView2.Columns[0].HeaderText = "ລະຫັດລ/ຄ";
        ...
        public Customoerrecord()
        {
            InitializeComponent();
        }

        private void Customoerrecord_Load(object sender, EventArgs e)
        {
            cd.connect();
            show();
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "SELECT * FROM customer WHERE birthday = @birthday";
