...
namespace final
{
    public partial class frmProduct : Form
    {
        ...
        {
            string sql = "select a.img, a.product_id, a.pro_name, b.cate_id, b.cate_name, c.brand_id, c.brand_name, d.unit_id, d.unit_name, a.qty, a.price, a.detail , e.shopname from product as a join category as b on a.cate_id = b.cate_id join brand as c on a.brand_id = c.brand_id join unit as d on a.unit_id = d.unit_id as e on e.shopname = e.shopname ";
            ...
            dataGridView1.Columns[12].HeaderText = "shopname";
        }
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            shopname.Text = dataGridView1.Rows[cindex].Cells[12].Value.ToString();
